...
public class SongGameActivity extends AppCompatActivity {
  private static final String TAG = SongGameActivity.class.getSimpleName();
  ...
  private String[] correctSequence2 = {
          "곰", "세", "마", "리", "가", "한", "집", "에", "있", "어",
          "아", "빠", "곰", "엄", "마", "곰", "애", "기", "곰", "아",
          "빠", "곰", "은", "뚱", "뚱", "해", "엄", "마", "곰", "은",
          "날", "씬", "해", "애", "기", "곰", "은", "너", "무", "귀",
  ...
  private String[] correctSequence3 = {
          "아", "기", "상", "어", "뚜", "루", "루", "뚜", "루", "루",
          "엄", "마", "상", "어", "뚜", "루", "루", "뚜", "루", "루",
          "아", "빠", "상", "어", "뚜", "루", "루", "뚜", "루", "루",
          "할", "머", "니", "상", "어", "뚜", "루", "루", "뚜", "루",
  ...
  private String[] soundSequence2 = {
          "솔", "솔", "미", "미", "솔", "솔", "미", "미", // 곰 세 마 리 가 한 집 에 있 어
          "솔", "라", "솔", "라", "솔", "라", "솔", "라", // 아 빠 곰 엄 마 곰 애 기 곰
          "솔", "라", "솔", "라", "솔", "라", "솔", "라", // 아 빠 곰 은 뚱 뚱 해
          "솔", "라", "솔", "라", "솔", "라", "솔", "라", // 엄 마 곰 은 날 씬 해
          "솔", "라", "솔", "라", "솔", "라", "솔", "라", // 애 기 곰 은 너 무 귀 여 워
          "솔", "라", "솔", "라", "솔", "라", "솔", "라"  // 으 쓱 으 쓱 잘 한 다
  };

  private String[] soundSequence3 = {
          "솔", "솔", "라", "솔", "미", "솔", // 아기 상어 뚜루루뚜루
          "솔", "솔", "라", "솔", "미", "솔", // 엄마 상어 뚜루루뚜루
          "솔", "솔", "라", "솔", "미", "솔", // 아빠 상어 뚜루루뚜루
          "솔", "솔", "라", "솔", "미", "솔", // 할머니 상어 뚜루루뚜루
          "솔", "솔", "라", "솔", "미", "솔", // 할아버지 상어 뚜루루뚜루
          "솔", "미", "솔", "미", "솔", "미", "레", // 우리는 바다의 사냥꾼
          "솔", "솔", "라", "솔", "미", "솔" // 아기 상어
  };
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_songgame);
    ...
    if(num == 2){
      lyrics = lyrics2;
      correctSequence = correctSequence2;
      soundSequence = soundSequence2;
    }else if(num == 3){
      lyrics = lyrics3;
      correctSequence = correctSequence3;
      soundSequence = soundSequence3;
    }

    // 목숨 TextView 초기화

    livesTextView = findViewById(R.id.livesTextView); // 레이아웃에서 목숨 TextView 찾기
    livesTextView.setText(":  " + lives + "  "); // 초기 목숨 설정
    livesTextView.setTextSize(30); // 목숨 텍스트 크기 설정
    livesTextView.setTextColor(getResources().getColor(android.R.color.black)); // 목숨 텍스트 색상 설정
  ...
  textViews = new TextView[correctSequence.length]; // TextView 배열 초기화
    ...
    textViews[i].setTextSize(30); // 텍스트 크기 설정 30
    textViews[i].setPadding(60, 16, 60, 16); // 패딩 설정 60 16 60 16
  ...
  private void reduceLives() {
    ...
    livesTextView.setText(":  " + lives + "  "); // 초기 목숨 설정
    if (lives <= 0) {
      // 목숨이 0이 되었을 때 게임 오버 처리
      showGameOverDialog();
      disableAllTextViews(); // 모든 TextView 클릭 불가능하게 설정
    }
  }
